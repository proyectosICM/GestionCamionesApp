...
export function VerCL() {
  ...
  const handleGo = (op, datos) => {
    if(op === "Camion"){
        navigation.navigate('Ver Datos', {datos: camion.checkListCamionModel, tc: "Camion", rol: rol, tablesD: datos})
    } else if(op === "Carreta") {
        navigation.navigate('Ver Datos', {datos: camion.checkListCarretaModel, tc: "Carreta", rol: rol, tablesD: datos})
    } else if(op === "Expreso"){
        navigation.navigate('Ver Datos', {datos: camion.checkListCamionModel, tc: "Camion", rol: rol, tablesD: datos})
    }
